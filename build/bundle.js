...
/***/ function(module, exports, __webpack_require__) {
	...
	var name = __webpack_require__(7).name;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ngRoute = _interopRequire(__webpack_require__(2));
	
	var ngCookies = _interopRequire(__webpack_require__(3));
	
	var ngResource = _interopRequire(__webpack_require__(11));
	
	var controllers = _interopRequire(__webpack_require__(9));
	
	var services = _interopRequire(__webpack_require__(10));
	
	module.exports = angular.module("blackjack", ["ngRoute", "ngResource", "ngCookies", services, controllers]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainController = _interopRequire(__webpack_require__(14));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameService = _interopRequire(__webpack_require__(12));
	
	var moduleName = "blackjack.services";
	
	angular.module(moduleName, []).service("blackjack.services.game", GameService);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerList = _interopRequire(__webpack_require__(15));
	
	var Deck = _interopRequire(__webpack_require__(16));
	...
	var _playerList = new PlayerList();
	var _deck = new Deck();
	...
	var GameService = (function () {
	    ...
	    _createClass(GameService, {
	        ...
	        deal: {
	            ...
	            value: function deal() {
	                _deck.shuffle();
	                _.each(_playerList.players, function (player) {
	        ...
	        setTotalPlayers: {
	            ...
	            value: function setTotalPlayers(totalPlayers) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var css = _interopRequire(__webpack_require__(17));
	
	var MainController = function MainController($scope, gameService) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lodash = _interopRequire(__webpack_require__(22));
	
	var Player = _interopRequire(__webpack_require__(19));
	...
	var PlayerList = (function () {
	  ...
	  */
	    ...
	    */
				...
				value: function makePlayers(numberOfPlayers) {
					var _this = this;
	
					_.each(_.range(numberOfPlayers + 1), function (id) {
						var name = id == 0 ? "Dealer" : "Player " + id;
						_this.players.push(new Player(id, name));
					});
	    ...
	    */
				...
				value: function getHandToBeat() {
					var player = _.max(this.players, function (player) {
	    ...
	    */
				...
				value: function makeWinners() {
					var _this = this;
	
					_.each(this.players, function (player) {
						if (player === _this.dealer) {
							if (!player.getBust() && player.getTotal() >= _this.getHandToBeat()) {
								player.setWinner();
							}
						} else if (!player.getBust() && player.getTotal() > _this.dealer.getTotal() || _this.dealer.getBust() && !player.getBust()) {
							player.setWinner();
						}
					});
				}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Card = _interopRequire(__webpack_require__(20));
	...
	var _suits = ["hearts", "diams", "clubs", "spades"];
	var _cardsPerSuit = 13;
	    ...
	    _createClass(Deck, {
	        makeCards: {
	            ...
	            value: function makeCards() {
	                _.each(_suits, function (suit) {
	                    _.each(_.range(_cardsPerSuit), function (id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/Users/Ben/Workspace/blackjack-game/node_modules/css-loader/index.js!/Users/Ben/Workspace/blackjack-game/node_modules/less-loader/index.js!/Users/Ben/Workspace/blackjack-game/app/blackjack/controllers/main/main.less", function() {
			var newContent = require("!!/Users/Ben/Workspace/blackjack-game/node_modules/css-loader/index.js!/Users/Ben/Workspace/blackjack-game/node_modules/less-loader/index.js!/Users/Ben/Workspace/blackjack-game/app/blackjack/controllers/main/main.less");
	...
	var Player = (function () {
	  ...
	  */
	    ...
	    */
				...
				value: function checkAces() {
					var _this = this;
	
					if (this.getBust()) {
						(function () {
							var foundAce = false;
							_.each(_this.hand, function (card) {
	    ...
	    */
				...
				value: function getTotal() {
					return _.reduce(this.hand, function (total, card) {
						total += card.value;
						return total;
					}, 0);
				}
